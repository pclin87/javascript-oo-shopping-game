...
const dateDiff = (date1, date2) => {
    ...
    let diffDates = Math.ceil(timeDiff /(1000 * 3600 * 24))
    return diffDates
};
...
function init(data) {
    ...
    const shop = (prodList, tBill, lastProd) => {
        ...
        let product = Object.is(lastProd, undefined) ? getProduct(prodList, prId) : product = lastProd; // Assign the value of product here
